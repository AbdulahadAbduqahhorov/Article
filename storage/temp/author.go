...
func CreateAuthor(author models.CreateAuthorModel) models.Author {
...
func GetAuthor() (authors []models.Author) {
...
func UpdateAuthor(author models.UpdateAuthorModel) (models.Author, error) {
